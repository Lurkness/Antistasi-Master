...
player createDiaryRecord ["Tutorial",["Start Position",
	"Find a good spot to begin the mission.
	 ...
	 If you start near a road between enemy zones, a patrol may appear and kill Petr"
]];
...
player createDiaryRecord ["Commander",["Move HQ","The Commander may select this option on the HQ Flag in order to move the HQ emplacement to another spot. This will allow you to move your HQ to a safer location or move closer to the front-lines. The closer your HQ is to the enemy, the greater the number of possibile side-missions you will have available. Remember! Keep Petr Safe or you will lose the game!"]];
player createDiaryRecord ["Commander",["Side Missions - Petr","Ask Petr for any type of mission you want. Mission availability is subject to HQ positioning, current allocated tasks and ownership of the surrounding areas"]];
...
player createDiaryRecord ["Diary",["HQ - Basics","Flag: Vehicle and Squad Unit Recruitment. Commander Options.<br/>Petr: Side-missions (Commander Only).<br/>Map: Game Options.<br/>Camp-fire: Rest for 8 hours (Commander Only)."]];
